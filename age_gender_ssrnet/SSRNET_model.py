...
from keras.layers import Input, Activation, add, Dense, Flatten, Dropout, Multiply, Embedding, Lambda, Add, Concatenate, Activation, Conv2D, AveragePooling2D, MaxPooling2D, BatchNormalization, Layer
